...
class IndexedOrderedDict(dict):
    ...
    def __eq__(self, other):
        ...
        order-insensitive.
        """
        if isinstance(other, collections.OrderedDict) or isinstance(
            other, IndexedOrderedDict
        ):
...
__all__ = ["IndexedOrderedDict", "IndexedKeysView", "IndexedValuesView", "IndexedItemsView",]
