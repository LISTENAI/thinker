# 自动化测试
## 工作原理
  * 使用Gitlab-Runner实现CI/CD，工作原理请参考办公网[zhuanlan.zhihu.com/p/344233428]
## 测试部署
  * 在内网如何部署Gitlab环境，请参考研发网[https://git-in.iflytek.com/RS_NEXTG-Group/doc/-/blob/master/gitlab-ci_configure/gitlab-ci.md]
## 添加用例
### 上传资源
  * curl -uadmin:AP3h3WrN1BkgU3akdKntKsNmtkyT51QAX9ZU5X -T xx/xx/xx.onnx  "http://soft-in.iflytek.com/artifactory/rdg_ai_research/thinker/models/"
