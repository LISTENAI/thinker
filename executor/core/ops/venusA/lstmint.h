...
static int32_t luna_lstm_q7_int8_inner(luna_lstm_param_t *params, int32_t t, int8_t *p_input, int8_t *p_output, int8_t *p_tmp) {
    ...
    THINKER_RET_CHECK(API_LIB(split_mat_mul_bias_i8i8i32o32)(p_hw_weight, p_h_in, p_hb_bias, gates_hidden, hidden_size * 4, hidden_size, 1, 0), "luna_split_mat_mul_bias_i8i8i32o32");
    
    if ((active_q_in > ib_q) && (active_q_in > hb_q)) {
        THINKER_RET_CHECK(API_LIB(scale_i32i32o32)(gates_input, 1 << (active_q_in - ib_q), gates_input, hidden_size * 4, 0), "luna_scale_i32i32o32");
        THINKER_RET_CHECK(API_LIB(scale_i32i32o32)(gates_hidden, 1 << (active_q_in - hb_q), gates_hidden, hidden_size * 4, 0), "luna_scale_i32i32o32");
    } else if (active_q_in > ib_q) {
        int32_t shift2 = hb_q - active_q_in;
        THINKER_RET_CHECK(API_LIB(scale_i32i32o32)(gates_input, 1 << (active_q_in - ib_q), gates_input, hidden_size * 4, 0), "luna_scale_i32i32o32");
        THINKER_RET_CHECK(API_LIB(scale_i32i32o32)(gates_hidden, 1, gates_hidden, hidden_size * 4, shift2), "luna_scale_i32i32o32");
    } else if (active_q_in > hb_q) {
        int32_t shift1 = ib_q - active_q_in;
        THINKER_RET_CHECK(API_LIB(scale_i32i32o32)(gates_input, 1, gates_input, hidden_size * 4, shift1), "luna_scale_i32i32o32");
        THINKER_RET_CHECK(API_LIB(scale_i32i32o32)(gates_hidden, 1 << (active_q_in - hb_q), gates_hidden, hidden_size * 4, 0), "luna_scale_i32i32o32");
    } else {
        int32_t shift1 = ib_q - active_q_in;
        int32_t shift2 = hb_q - active_q_in;
    ...
    THINKER_RET_CHECK(API_LIB(add_i32i32o32)(gates_input, gates_hidden, gates_input, hidden_size * 4, 0), "luna_add_i32i32o32");
    ...
    THINKER_RET_CHECK(API_LIB(sigmoid_i32o32)(G_i, G_i, hidden_size), "luna_sigmoid_i32o32");
    THINKER_RET_CHECK(API_LIB(sigmoid_i32o32)(G_f, G_f, hidden_size), "luna_sigmoid_i32o32");
    THINKER_RET_CHECK(API_LIB(tanh_i32o32)(G_c, G_c, hidden_size), "luna_tanh_i32o32");
    THINKER_RET_CHECK(API_LIB(sigmoid_i32o32)(G_o, G_o, hidden_size), "luna_sigmoid_i32o32");
    
    THINKER_RET_CHECK(API_LIB(scale_i32i32o32)(G_i, 1, G_i, hidden_size, 16), "luna_scale_i32i32o32");
    THINKER_RET_CHECK(API_LIB(scale_i32i32o32)(G_f, 1, G_f, hidden_size, 16), "luna_scale_i32i32o32");
    THINKER_RET_CHECK(API_LIB(scale_i32i32o32)(G_c, 1, G_c, hidden_size, 16), "luna_scale_i32i32o32");
    ...
    THINKER_RET_CHECK(API_LIB(tanh_i32o32)(p_cell_in, hidden_new, hidden_size), "luna_tanh_i32o32");
    THINKER_RET_CHECK(API_LIB(scale_i32i32o32)(p_cell_in, 1, p_cell_in, hidden_size, 12), "luna_scale_i32i32o32");
    THINKER_RET_CHECK(API_LIB(scale_i32i32o32)(hidden_new, 1, hidden_new, hidden_size, 16), "luna_scale_i32i32o32");
    THINKER_RET_CHECK(API_LIB(mul_i32i32o8)(G_o, hidden_new, p_h_in, hidden_size, 30 - h_q), "luna_mul_i32i32o8");
    THINKER_RET_CHECK(API_LIB(scale_i8i8o8)(p_h_in, 1, p_out, hidden_size, 0), "luna_scale_i8o8"); 
