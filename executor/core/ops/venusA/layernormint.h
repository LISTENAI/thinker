...
/**
 * @brief Precomputed table for square root reciprocal (Q15 format)
 */
static const int16_t g_s16Table_sqrt_reciprocal[768] =
    {/* Q15 values for [0.25-1] */
...
/**
 * @brief Layer normalization implementation for integer data types
