...
int32_t luna_clx_mul_i32i32o16(const int32_t *src1, const int32_t *src2, int16_t *dst, uint32_t size, uint32_t shift);
...
int32_t luna_clx_mul_real_i32i32o8(const int32_t *src1, const int32_t *src2, int8_t *dst, uint32_t size, uint32_t shift);
int32_t luna_clx_mul_real_i32i32o16(const int32_t *src1, const int32_t *src2, int16_t *dst, uint32_t size, uint32_t shift);
...
int32_t luna_clx_mul_out_real_i32i32o64(const int32_t *src1, const int32_t *src2, int64_t *dst, uint32_t size, uint32_t shift);
int32_t luna_conjugate_i8o8(const int8_t *src, int8_t *dst, uint32_t size, uint32_t shift);
int32_t luna_conjugate_i8o16(const int8_t *src, int16_t *dst, uint32_t size, uint32_t shift);
int32_t luna_conjugate_i16o8(const int16_t *src, int8_t *dst, uint32_t size, uint32_t shift);
int32_t luna_conjugate_i16o16(const int16_t *src, int16_t *dst, uint32_t size, uint32_t shift);
int32_t luna_conjugate_i16o32(const int16_t *src, int32_t *dst, uint32_t size, uint32_t shift);
int32_t luna_conjugate_i32o8(const int32_t *src, int8_t *dst, uint32_t size, uint32_t shift);
int32_t luna_conjugate_i32o16(const int32_t *src, int16_t *dst, uint32_t size, uint32_t shift);
int32_t luna_conjugate_i32o32(const int32_t *src, int32_t *dst, uint32_t size, uint32_t shift);
int32_t luna_conjugate_i32o64(const int32_t *src, int64_t *dst, uint32_t size, uint32_t shift);
