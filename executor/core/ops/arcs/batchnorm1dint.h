#ifndef _BATCHNORM1DINT_ARCS_H_
#define _BATCHNORM1DINT_ARCS_H_
...
int32_t batchnorm1dint_luna(const tTensor *X, const tTensor *W, const tTensor *Bias,
    ...
    for (int32_t i = 0; i < N; ++i) {
        for (int32_t j = 0; j < C; ++j) {
            ...
            THINKER_RET_CHECK(API_LIB(scale_i8i8o32)(p_in, p_weight[j], p_tmp, F, 0),
                              "luna_scale_i8i8o32");
            THINKER_RET_CHECK(API_LIB(offset_i32i32o8)(p_tmp, p_bias[j], p_out, F, shift),
                              "luna_offset_i32i32o8");
        }
    }
    return T_SUCCESS;
}
