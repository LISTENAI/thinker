...
/**
 * @brief Calculate ceiling division for integer division
 * @param x Numerator
 * @param shift Bit shift for division
...
/**
 * @brief Calculate optimal split number for matrix multiplication
 * @param M First dimension
 * @param N Second dimension  
 * @param L Third dimension
 * @param byte Byte size
 * @return Optimal split number
 */
...
/**
 * @brief Core LSTM computation for quantized 8-bit integers
...
/**
 * @brief LSTM computation with DMA list support
 * @param params LSTM parameters
 * @param t Time step
 * @param p_input Input tensor
 * @param p_output Output tensor
