...
/**
 * @brief Precomputed square root reciprocal table for Q15 values
 */
static const int16_t g_s16Table_sqrt_reciprocal[768] =
    {/* Q15 values from 0.25 to 1.0 */
...
/**
 * @brief Shift and floor operation for integer division
 * @param x Input integer
 * @param shift Number of bits to shift
 * @return int32_t Result after shift and floor
 */
...
/**
 * @brief Calculate square root reciprocal using precomputed table
 * @param data Input data
 * @param q_x Quantization factor of input data
 * @param table_shift Pointer to store the shift value
...
/**
 * @brief Layer normalization function for integer quantized tensors
 * @param X Input tensor
 * @param W Gamma tensor (scale parameters)
 * @param Bias Beta tensor (offset parameters)
