...
#define THINKER_VERSION_PATCH 13
...
#ifndef THINKER_TARGET_PLATFORM
#define THINKER_TARGET_PLATFORM THINKER_TARGET_PLATFORM_NONE
#endif

#if THINKER_TARGET_PLATFORM == THINKER_TARGET_PLATFORM_VENUS
#include "core/ops/venus/luna/luna.h"
#define THINKER_TARGET_PLATFORM_NAME "venus"
#define THINKER_TARGET_PLATFORM_RESOURCE_TAG 0
#elif THINKER_TARGET_PLATFORM == THINKER_TARGET_PLATFORM_ARCS
#include "core/ops/arcs/luna/luna.h"
#define THINKER_TARGET_PLATFORM_NAME "arcs"
#define THINKER_TARGET_PLATFORM_RESOURCE_TAG 2
#elif THINKER_TARGET_PLATFORM == THINKER_TARGET_PLATFORM_VENUSA
...
#if THINKER_TARGET_PLATFORM != THINKER_TARGET_PLATFORM_NONE
