...
-------------------------------------------------------------------------*/
void   vec_int2float (float32_t * y, const int32_t * x, int t, int N);
...
/*-------------------------------------------------------------------------
  ...
  t should be in range -126...126
-------------------------------------------------------------------------*/
void   vec_float2int (int32_t * y, const float32_t * x, int t, int N);
int32_t scl_float2int (float32_t x, int t);


int vec_mulf(float32_t * __restrict__ p_out, const float32_t * __restrict__ p_inp1, const float32_t * __restrict__ p_inp2, int num_elm);
